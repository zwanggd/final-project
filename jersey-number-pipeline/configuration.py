pose_home = '/Users/kai/GSR/soccernet/jersey-number-pipeline/pose/ViTPose'
pose_env = 'vitpose'

str_home = '/Users/kai/GSR/soccernet/jersey-number-pipeline/str/parseq'
str_env = 'parseq2'
str_platform = 'cu113'

# centroids
reid_env = 'centroids'
reid_script = '/Users/kai/GSR/soccernet/jersey-number-pipeline/centroid_reid.py'

reid_home = '/Users/kai/GSR/soccernet/jersey-number-pipeline/reid'


dataset = {'SoccerNet':
                {'root_dir': '/Users/kai/GSR/data/SoccerNetGS/converted/testing_clips',
                 'working_dir': '/Users/kai/GSR/soccernet/jersey-number-pipeline/out/SoccerNetResults',
                 'test': {
                        'images': 'test/images',
                 ...
                 'challenge': {
                        'images': 'SNGS-000',
                        'feature_output_folder': '/Users/kai/GSR/soccernet/jersey-number-pipeline/out/SoccerNetResults/challenge',
                        'gt': '',
                 ...
                 'legibility_model': "/Users/kai/GSR/soccernet/jersey-number-pipeline/models/legibility_resnet34_soccer_20240215.pth",
                 ...
                 'str_model': '/Users/kai/GSR/soccernet/jersey-number-pipeline/models/parseq_epoch=24-step=2575-val_accuracy=95.6044-val_NED=96.3255.ckpt',
