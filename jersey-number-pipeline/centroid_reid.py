...
ROOT = '/Users/kai/GSR/soccernet/jersey-number-pipeline/reid/centroids-reid'
import sys
import os

# Add the path of your local config to sys.path (ensure it's at the top of the list)
sys.path.insert(0, '/Users/kai/GSR/soccernet/jersey-number-pipeline/reid/centroids-reid')

# Reimport config to make sure it uses the correct file
import config
print(f"Config module loaded from: {config.__file__}")
