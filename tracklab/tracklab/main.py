...
def main(cfg):
    ...
    if cfg.test_tracking:
        ...
        log.info("Start counting for tracking...")
        # Run tracking and visualization
        tracking_engine.track_dataset(max_videos=max_videos)
        # log.info(f"Tracking and visualization took {time.time() - start_time:.2f} seconds")

        # tracker_state.detections_pred.to_csv('track_state_debug.csv', index=False)
